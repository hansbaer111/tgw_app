...
mixin _$ExerciseModel {
  ...
  List<ExerciseTags> get tags => throw _privateConstructorUsedError;
...
class _$ExerciseModelImpl implements _ExerciseModel {
  const _$ExerciseModelImpl(
      ...
      required final List<ExerciseTags> tags,
      this.videoUrl})
  ...
  final List<ExerciseTags> _tags;
  @override
  List<ExerciseTags> get tags {
  ...
  @override
  String toString() {
    return 'ExerciseModel(id: $id, name: $name, description: $description, muscleGroups: $muscleGroups, equipment: $equipment, movementPattern: $movementPattern, tags: $tags, videoUrl: $videoUrl)';
  }
...
class _$ExerciseTagsImpl implements _ExerciseTags {
  const _$ExerciseTagsImpl({required this.name, required this.value});
  ...
  @override
  String toString() {
    return 'ExerciseTags(name: $name, value: $value)';
  }
...
abstract class _ExerciseTags implements ExerciseTags {
  const factory _ExerciseTags(
      {required final String name,
      required final String value}) = _$ExerciseTagsImpl;
